...
public class WnkExcelFileDownloadView extends AbstractView {
	
	private static final Logger logger = LoggerFactory.getLogger(WnkExcelFileDownloadView.class);
	private static final String CHARSET = "utf-8";
	
	public WnkExcelFileDownloadView() { }
